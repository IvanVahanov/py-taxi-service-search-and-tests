...
class SearchFeatureTests(TestCase):
    def setUp(self):
        ...
        self.driver1 = Driver.objects.create_user(
            username="john_doe", password="password123", license_number="ABC12345"
        )
        self.driver2 = Driver.objects.create_user(
            username="jane_doe", password="password123", license_number="XYZ67890"
        )
    ...
    def test_search_driver(self):
        response = self.client.get(reverse("taxi:driver-list"), {"q": "john_doe"})
